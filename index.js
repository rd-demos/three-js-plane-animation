...
// Lights, Camera... Action! (initializations of camera/renderer/lights and other tools)
...
// Plane Creation and Customization
...
function animate() {
  ...
  for (let i = 0; i < array.length; i += 3) {
    // X Coordinate Random static motion
    array[i] = originalPosition[i] + Math.cos(frame + randomValues[i]) * 0.005;
    // Y Coordinate Random static motion
